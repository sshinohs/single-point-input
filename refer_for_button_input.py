# https://codingshiksha.com/python/python-3-pyqt5-script-to-display-virtual-onscreen-keyboard-to-take-input-using-qt-virtualkeyboard-widget-in-canvas-window-gui-desktop-app-full-project-for-beginners/
import sys
